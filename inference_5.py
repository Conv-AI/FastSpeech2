...
ckpt_file_path = '/workspace/nemo/vol/Fastspeech2/output/ckpt/Nova/3000.pth.tar'
...
def save_predicted_mels(mel_predictions, emotion_list, speaker_list, basename_list, target_dir = '/workspace/nemo/vol/extvol2/mels2' ):
    save_paths = []
...
emotion_json_path = "/workspace/nemo/vol/extvol3/Nova-2/Nova-Voice-Dataset/preprocessed_data/emotions.json"
EMOTION_DICT = {}

with open(emotion_json_path) as f:
    EMOTION_DICT = json.loads(f.read())
    
speakers_json_path = "/workspace/nemo/vol/extvol3/Nova-2/Nova-Voice-Dataset/preprocessed_data/speakers.json"
SPEAKER_ID_DICT = {}
...
class Dataset(Dataset):
    ...
    def process_meta(self):
        ...
        for index, row in data.iterrows():
            ...
            if os.path.exists(f"/workspace/nemo/vol/extvol3/mels2/mel_{s}_{e}_{n}.npy"):
