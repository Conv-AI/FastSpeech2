...
def evaluate(model, step, configs, logger=None, vocoder=None, accelerator=None, device=None):
    ...
    message_ = {"total_loss": loss_means[0], "mel loss": loss_means[1], "postnet loss": loss_means[2],
    ...
    if logger is not None:
        ...
        log(logger, step, losses=loss_means, logger_stage="validation")
        log(
            logger,
            fig=fig,
